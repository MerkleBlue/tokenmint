...
export const SET_TOKEN_OWNER_BALANCE = "SET_TOKEN_OWNER_BALANCE";
export const SET_INFO_MESSAGE = "SET_INFO_MESSAGE";
export const SET_SERVICE_FEE = "SET_SERVICE_FEE";
export const SET_NETWORK = "SET_NETWORK";
export const SET_CHECKING_NETWORK = "SET_CHECKING_NETWORK";
export const SET_TOKEN_OWNER_HAS_INSUFFICIENT_FUNDS = "SET_TOKEN_OWNER_HAS_INSUFFICIENT_FUNDS";
